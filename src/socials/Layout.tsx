		...
		<div>
			<div className="flex w-full h-72">
				...
				<div className="flex flex-grow flex-col relative">
					<div className="bg-skin-fill rounded-lg absolute w-full lg:h-52 h-full flex-grow flex justify-center items-center p-4 pt-0">
				...
				<div className="hidden w-32 bg-skin-fill-highlight lg:flex flex-col">
					<div className="h-24 bg-skin-fill rounded-lg"></div>
					<div className="flex-grow rounded-lg"></div>
				</div>
			</div>
		</div>
